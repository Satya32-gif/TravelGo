            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0 lg:px-16">
                ...
                >
                  ...
                  where wanderlust meets curated adventures. Immerse yourself in the allure of global travel as we invite you to 
                  traverse the planet's most breathtaking landscapes, vibrant cultures, and hidden gems. From awe-inspiring 
                  natural wonders to bustling urban landscapes, our meticulously crafted itineraries promise an unforgettable 
                  exploration of diverse destinations. Join us in unraveling the beauty of every corner of the world, creating 
                  memories that will last a lifetime. Let your wanderlust take flight, and let us be your guide to the 
                  extraordinary tapestry of our planet's wonders.
                  <br />
                </p>
